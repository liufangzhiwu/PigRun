...
public class Map : MonoBehaviour
{
    ...
    public class PlacedItem
    {
        ...
        public List<Vector2Int> occupiedCells;   // 预计算的所有占用格子
    }

    // ==================== 占用表和实例管理 ====================
    public int[,] occupancy;                                           // 网格占用表
    Dictionary<int, PlacedItem> items = new Dictionary<int, PlacedItem>();
    int nextId = 1;
    PlacedItem selected;
    ...
    int GetOccupant(Vector2Int cell) => occupancy[cell.x, cell.y];
